		...
		<div class="columns-3 offset-by-1">
			<div class="restaurant-info">
				...
				<div class="restaurant-data">
					...
					<?php if ($phone != ''){ ?>
						<div class="phone">
							<i class="fa fa-fw fa-mobile-phone"><span class="sr-only">Phone:</span></i><?php echo $phone; ?>
						</div>
					<?php } ?>
					<div class="hours">
						<?php echo $h_oop; ?>
				...
				<?php if ($open_table != ""){ ?>
					<div class="loc-button open-table">
						<a href="<?php echo $open_table; ?>" target="_blank">Find a table</a>
					</div>
				<?php } ?>
				...
				<div class="loc-button menu">
					<?php if( $menu != ''){ ?>
						<span class="desktop">
							<a href="<?php echo $menu; ?>" target="_blank">View the menu</a>
						</span>
					<?php } ?>
					<?php if( $menu != ''){ ?>
						<span class="mobile">
							<a href="<?php echo $menu_mobile; ?>" target="_blank">View the menu</a>
						</span>
					<?php } ?>
				</div>
				<?php } ?>
				<div class="loc-button directions">
					<a href="<?echo $gmd_link; ?>" target="_blank">Get Directions</a>
				</div>
